...
(async () => {
  ...
  /* Число карточек тут не вписано руками: список метрик растёт, и проверка,
     которая знает своё «шестнадцать», начнёт падать на каждой новой. Смысл
     в другом — что отрисован весь список, а не его часть. */
  ok('и сохранённый расчёт с выключенной вкладки туда же не уводит',
    ONLY.карточек === ONLY.вСписке && ONLY.вСписке >= 16, ONLY);
